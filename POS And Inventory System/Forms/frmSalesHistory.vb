...
Public Class frmSalesHistory
    ...
    Private Sub frmSalesHistory_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        Try
            sSql = "SELECT SalesID, [LastName] & ', ' & [FirstName] AS Name, Address, Date, DiscountAmount, Net " _
                    & "FROM Sales INNER JOIN Customer ON Sales.CustomerID = Customer.CustomerID"
    ...
    Private Sub btnSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        ...
        Else
            sSql = "SELECT SalesID, [LastName] & ', ' & [FirstName] AS Name, Address, Date, DiscountAmount, Net " _
                    & "FROM Sales INNER JOIN Customer ON Sales.CustomerID = Customer.CustomerID WHERE [Name] Like '%" & txtSearch.Text & "%' OR [Address] Like '%" & txtSearch.Text & "%'"
        End If
    ...
    Private Sub dgvList_CellDoubleClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvList.CellDoubleClick
        ...
        SalesID = dgvList.Item(0, i).Value
