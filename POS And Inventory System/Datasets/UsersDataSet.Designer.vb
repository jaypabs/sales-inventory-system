...
Partial Public Class UsersDataSet
    ...
    Partial Public Class UsersDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddUsersRow(ByVal Username As String, ByVal Password As String, ByVal Name As String, ByVal is_Admin As Boolean, ByVal DateAdded As Date, ByVal EncodedBy As Integer) As UsersRow
            Dim rowUsersRow As UsersRow = CType(Me.NewRow,UsersRow)
            Dim columnValuesArray() As Object = New Object() {Username, Password, Name, is_Admin, DateAdded, EncodedBy}
    ...
    Partial Public Class UsersRow
        ...
        Public Property is_Admin() As Boolean
            Get
                Try 
                    Return CType(Me(Me.tableUsers.is_AdminColumn),Boolean)
                Catch e As Global.System.InvalidCastException
        ...
        Public Property EncodedBy() As Integer
            Get
                Try 
                    Return CType(Me(Me.tableUsers.EncodedByColumn),Integer)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'EncodedBy' in table 'Users' is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableUsers.EncodedByColumn) = value
            End Set
        End Property
        ...
        Public Function IsEncodedByNull() As Boolean
            Return Me.IsNull(Me.tableUsers.EncodedByColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Sub SetEncodedByNull()
            Me(Me.tableUsers.EncodedByColumn) = Global.System.Convert.DBNull
        End Sub
    End Class
    ...
    Partial Public Class UsersTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Users` WHERE ((`Username` = ?) AND ((? = 1 AND `Password` IS NULL) O"& _ 
                ...
                " AND `is_Admin` IS NULL) OR (`is_Admin` = ?)) AND ((? = 1 AND `DateAdded` IS NUL"& _ 
                "L) OR (`DateAdded` = ?)) AND ((? = 1 AND `EncodedBy` IS NULL) OR (`EncodedBy` = "& _ 
                "?)))"
            ...
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("IsNull_is_Admin", Global.System.Data.OleDb.OleDbType.[Integer], 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "is_Admin", Global.System.Data.DataRowVersion.Original, true, Nothing))
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Original_is_Admin", Global.System.Data.OleDb.OleDbType.[Boolean], 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "is_Admin", Global.System.Data.DataRowVersion.Original, false, Nothing))
            ...
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("IsNull_EncodedBy", Global.System.Data.OleDb.OleDbType.[Integer], 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "EncodedBy", Global.System.Data.DataRowVersion.Original, true, Nothing))
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Original_EncodedBy", Global.System.Data.OleDb.OleDbType.[Integer], 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "EncodedBy", Global.System.Data.DataRowVersion.Original, false, Nothing))
            Me._adapter.InsertCommand = New Global.System.Data.OleDb.OleDbCommand()
            Me._adapter.InsertCommand.Connection = Me.Connection
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `Users` (`Username`, `Password`, `Name`, `is_Admin`, `DateAdded`, `En"& _ 
                "codedBy`) VALUES (?, ?, ?, ?, ?, ?)"
            ...
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("is_Admin", Global.System.Data.OleDb.OleDbType.[Boolean], 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "is_Admin", Global.System.Data.DataRowVersion.Current, false, Nothing))
            ...
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("EncodedBy", Global.System.Data.OleDb.OleDbType.[Integer], 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "EncodedBy", Global.System.Data.DataRowVersion.Current, false, Nothing))
            Me._adapter.UpdateCommand = New Global.System.Data.OleDb.OleDbCommand()
            Me._adapter.UpdateCommand.Connection = Me.Connection
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Users` SET `Username` = ?, `Password` = ?, `Name` = ?, `is_Admin` = ?, `D"& _ 
                "ateAdded` = ?, `EncodedBy` = ? WHERE ((`Username` = ?) AND ((? = 1 AND `Password"& _ 
                "` IS NULL) OR (`Password` = ?)) AND ((? = 1 AND `Name` IS NULL) OR (`Name` = ?))"& _ 
                " AND ((? = 1 AND `is_Admin` IS NULL) OR (`is_Admin` = ?)) AND ((? = 1 AND `DateA"& _ 
                "dded` IS NULL) OR (`DateAdded` = ?)) AND ((? = 1 AND `EncodedBy` IS NULL) OR (`E"& _ 
                "ncodedBy` = ?)))"
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("is_Admin", Global.System.Data.OleDb.OleDbType.[Boolean], 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "is_Admin", Global.System.Data.DataRowVersion.Current, false, Nothing))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("EncodedBy", Global.System.Data.OleDb.OleDbType.[Integer], 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "EncodedBy", Global.System.Data.DataRowVersion.Current, false, Nothing))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("IsNull_is_Admin", Global.System.Data.OleDb.OleDbType.[Integer], 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "is_Admin", Global.System.Data.DataRowVersion.Original, true, Nothing))
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Original_is_Admin", Global.System.Data.OleDb.OleDbType.[Boolean], 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "is_Admin", Global.System.Data.DataRowVersion.Original, false, Nothing))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("IsNull_EncodedBy", Global.System.Data.OleDb.OleDbType.[Integer], 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "EncodedBy", Global.System.Data.DataRowVersion.Original, true, Nothing))
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Original_EncodedBy", Global.System.Data.OleDb.OleDbType.[Integer], 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "EncodedBy", Global.System.Data.DataRowVersion.Original, false, Nothing))
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT Username, [Password], Name, is_Admin, DateAdded, EncodedBy FROM Users"
        ...
        Public Overloads Overridable Function Delete(ByVal Original_Username As String, ByVal Original_Password As String, ByVal Original_Name As String, ByVal Original_is_Admin As Boolean, ByVal Original_DateAdded As Global.System.Nullable(Of Date), ByVal Original_EncodedBy As Global.System.Nullable(Of Integer)) As Integer
            ...
            Me.Adapter.DeleteCommand.Parameters(6).Value = CType(Original_is_Admin,Boolean)
            ...
            If (Original_EncodedBy.HasValue = true) Then
                ...
                Me.Adapter.DeleteCommand.Parameters(10).Value = CType(Original_EncodedBy.Value,Integer)
            Else
        ...
        Public Overloads Overridable Function Insert(ByVal Username As String, ByVal Password As String, ByVal Name As String, ByVal is_Admin As Boolean, ByVal DateAdded As Global.System.Nullable(Of Date), ByVal EncodedBy As Global.System.Nullable(Of Integer)) As Integer
            ...
            If (EncodedBy.HasValue = true) Then
                Me.Adapter.InsertCommand.Parameters(5).Value = CType(EncodedBy.Value,Integer)
            Else
        ...
        Public Overloads Overridable Function Update(ByVal Username As String, ByVal Password As String, ByVal Name As String, ByVal is_Admin As Boolean, ByVal DateAdded As Global.System.Nullable(Of Date), ByVal EncodedBy As Global.System.Nullable(Of Integer), ByVal Original_Username As String, ByVal Original_Password As String, ByVal Original_Name As String, ByVal Original_is_Admin As Boolean, ByVal Original_DateAdded As Global.System.Nullable(Of Date), ByVal Original_EncodedBy As Global.System.Nullable(Of Integer)) As Integer
            If (Username Is Nothing) Then
            ...
            End If
            If (EncodedBy.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(5).Value = CType(EncodedBy.Value,Integer)
            Else
            ...
            Me.Adapter.UpdateCommand.Parameters(12).Value = CType(Original_is_Admin,Boolean)
            If (Original_DateAdded.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(13).Value = CType(0,Object)
                Me.Adapter.UpdateCommand.Parameters(14).Value = CType(Original_DateAdded.Value,Date)
            Else
            ...
            If (Original_EncodedBy.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(16).Value = CType(Original_EncodedBy.Value,Integer)
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal Password As String, ByVal Name As String, ByVal is_Admin As Boolean, ByVal DateAdded As Global.System.Nullable(Of Date), ByVal EncodedBy As Global.System.Nullable(Of Integer), ByVal Original_Username As String, ByVal Original_Password As String, ByVal Original_Name As String, ByVal Original_is_Admin As Boolean, ByVal Original_DateAdded As Global.System.Nullable(Of Date), ByVal Original_EncodedBy As Global.System.Nullable(Of Integer)) As Integer
            Return Me.Update(Original_Username, Password, Name, is_Admin, DateAdded, EncodedBy, Original_Username, Original_Password, Original_Name, Original_is_Admin, Original_DateAdded, Original_EncodedBy)
        End Function
    End Class
