...
Public Class frmProductList
    ...
    Private Sub frmProductList_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        Try
            sSql = "SELECT ProductID, ProductName, Description, Category.Category, SubCategory.Subcategory, Brand.Brand " _
                    & "FROM ((Product INNER JOIN Category ON Product.CategoryID = Category.CategoryID) INNER JOIN SubCategory " _
                    & "ON Product.SubCategoryID = SubCategory.SubcategoryID) INNER JOIN Brand ON Product.BrandID = Brand.BrandID;"
    ...
    Private Sub LoadDS(ByVal sSQL As String)
        ...
        dtSource = ds.Tables("Product")
    End Sub

    Private Sub btnNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNew.Click
        Dim Product As New frmProduct

        Product.getFormState = modGlobal.FormState.adStateAddMode
    ...
    Private Sub btnSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        ...
        Else
            sSql = "SELECT ProductID, ProductName, Description, Category.Category, SubCategory.Subcategory, Brand.Brand " _
                    & "FROM ((Product INNER JOIN Category ON Product.CategoryID = Category.CategoryID) INNER JOIN SubCategory " _
                    & "ON Product.SubCategoryID = SubCategory.SubcategoryID) INNER JOIN Brand ON Product.BrandID = Brand.BrandID WHERE [ProductName] Like '%" & txtSearch.Text & "%' OR [Description] Like '%" & txtSearch.Text & "%'"
        End If
    ...
    Private Sub dgvList_CellDoubleClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvList.CellDoubleClick
        ...
        ProductID = dgvList.Item(0, i).Value
