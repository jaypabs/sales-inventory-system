...
Partial Public Class EmployeeDataSet
    ...
    Partial Public Class EmployeeDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddEmployeeRow(ByVal FirstName As String, ByVal LastName As String, ByVal ContactNo As String, ByVal Email As String, ByVal Address As String, ByVal BirthDate As Date, ByVal Position As String, ByVal JobDescription As String) As EmployeeRow
            Dim rowEmployeeRow As EmployeeRow = CType(Me.NewRow,EmployeeRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, FirstName, LastName, ContactNo, Email, Address, BirthDate, Position, JobDescription}
        ...
        Private Sub InitClass()
            ...
            Me.columnJobDescription.MaxLength = 255
        End Sub
    ...
    Partial Public Class EmployeeRow
        ...
        Public Property JobDescription() As String
            Get
                Try 
                    Return CType(Me(Me.tableEmployee.JobDescriptionColumn),String)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'JobDescription' in table 'Employee' is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableEmployee.JobDescriptionColumn) = value
            End Set
        End Property
        ...
        Public Function IsContactNoNull() As Boolean
            Return Me.IsNull(Me.tableEmployee.ContactNoColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Sub SetContactNoNull()
            Me(Me.tableEmployee.ContactNoColumn) = Global.System.Convert.DBNull
        End Sub
        ...
        Public Function IsJobDescriptionNull() As Boolean
            Return Me.IsNull(Me.tableEmployee.JobDescriptionColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Sub SetJobDescriptionNull()
            Me(Me.tableEmployee.JobDescriptionColumn) = Global.System.Convert.DBNull
        End Sub
    End Class
    ...
    Partial Public Class EmployeeTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Employee` WHERE ((`EmployeeID` = ?) AND ((? = 1 AND `FirstName` IS N"& _ 
                ...
                "Email` IS NULL) OR (`Email` = ?)) AND ((? = 1 AND `Address` IS NULL) OR (`Addres"& _ 
                "s` = ?)) AND ((? = 1 AND `BirthDate` IS NULL) OR (`BirthDate` = ?)) AND ((? = 1 "& _ 
                "AND `Position` IS NULL) OR (`Position` = ?)) AND ((? = 1 AND `JobDescription` IS"& _ 
                " NULL) OR (`JobDescription` = ?)))"
            ...
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("IsNull_JobDescription", Global.System.Data.OleDb.OleDbType.[Integer], 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "JobDescription", Global.System.Data.DataRowVersion.Original, true, Nothing))
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Original_JobDescription", Global.System.Data.OleDb.OleDbType.VarWChar, 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "JobDescription", Global.System.Data.DataRowVersion.Original, false, Nothing))
            Me._adapter.InsertCommand = New Global.System.Data.OleDb.OleDbCommand()
            Me._adapter.InsertCommand.Connection = Me.Connection
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `Employee` (`FirstName`, `LastName`, `ContactNo`, `Email`, `Address`,"& _ 
                " `BirthDate`, `Position`, `JobDescription`) VALUES (?, ?, ?, ?, ?, ?, ?, ?)"
            ...
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("JobDescription", Global.System.Data.OleDb.OleDbType.VarWChar, 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "JobDescription", Global.System.Data.DataRowVersion.Current, false, Nothing))
            Me._adapter.UpdateCommand = New Global.System.Data.OleDb.OleDbCommand()
            Me._adapter.UpdateCommand.Connection = Me.Connection
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Employee` SET `FirstName` = ?, `LastName` = ?, `ContactNo` = ?, `Email` ="& _ 
                " ?, `Address` = ?, `BirthDate` = ?, `Position` = ?, `JobDescription` = ? WHERE ("& _ 
                "(`EmployeeID` = ?) AND ((? = 1 AND `FirstName` IS NULL) OR (`FirstName` = ?)) AN"& _ 
                "D ((? = 1 AND `LastName` IS NULL) OR (`LastName` = ?)) AND ((? = 1 AND `ContactN"& _ 
                "o` IS NULL) OR (`ContactNo` = ?)) AND ((? = 1 AND `Email` IS NULL) OR (`Email` ="& _ 
                " ?)) AND ((? = 1 AND `Address` IS NULL) OR (`Address` = ?)) AND ((? = 1 AND `Bir"& _ 
                "thDate` IS NULL) OR (`BirthDate` = ?)) AND ((? = 1 AND `Position` IS NULL) OR (`"& _ 
                "Position` = ?)) AND ((? = 1 AND `JobDescription` IS NULL) OR (`JobDescription` ="& _ 
                " ?)))"
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("JobDescription", Global.System.Data.OleDb.OleDbType.VarWChar, 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "JobDescription", Global.System.Data.DataRowVersion.Current, false, Nothing))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("IsNull_JobDescription", Global.System.Data.OleDb.OleDbType.[Integer], 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "JobDescription", Global.System.Data.DataRowVersion.Original, true, Nothing))
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Original_JobDescription", Global.System.Data.OleDb.OleDbType.VarWChar, 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "JobDescription", Global.System.Data.DataRowVersion.Original, false, Nothing))
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT EmployeeID, FirstName, LastName, ContactNo, Email, Address, BirthDate, [Po"& _ 
                "sition], JobDescription FROM Employee"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1) = New Global.System.Data.OleDb.OleDbCommand()
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT EmployeeID, FirstName, LastName, ContactNo, Email, Address, BirthDate, [Po"& _ 
                "sition], JobDescription FROM Employee"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE EmployeeID = ?"
        ...
        Public Overloads Overridable Function FillBy(ByVal dataTable As EmployeeDataSet.EmployeeDataTable, ByVal EmployeeID As Integer) As Integer
        ...
        Public Overloads Overridable Function GetDataBy(ByVal EmployeeID As Integer) As EmployeeDataSet.EmployeeDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(1)
            Me.Adapter.SelectCommand.Parameters(0).Value = CType(EmployeeID,Integer)
            Dim dataTable As EmployeeDataSet.EmployeeDataTable = New EmployeeDataSet.EmployeeDataTable()
            Me.Adapter.Fill(dataTable)
        ...
        Public Overloads Overridable Function Delete(ByVal Original_EmployeeID As Integer, ByVal Original_FirstName As String, ByVal Original_LastName As String, ByVal Original_ContactNo As String, ByVal Original_Email As String, ByVal Original_Address As String, ByVal Original_BirthDate As Global.System.Nullable(Of Date), ByVal Original_Position As String, ByVal Original_JobDescription As String) As Integer
            ...
            Else
                ...
                Me.Adapter.DeleteCommand.Parameters(16).Value = CType(Original_JobDescription,String)
            End If
        ...
        Public Overloads Overridable Function Insert(ByVal FirstName As String, ByVal LastName As String, ByVal ContactNo As String, ByVal Email As String, ByVal Address As String, ByVal BirthDate As Global.System.Nullable(Of Date), ByVal Position As String, ByVal JobDescription As String) As Integer
            ...
            Else
                Me.Adapter.InsertCommand.Parameters(7).Value = CType(JobDescription,String)
            End If
        ...
        Public Overloads Overridable Function Update( _
                    ...
                    ByVal Original_JobDescription As String) As Integer
            If (FirstName Is Nothing) Then
            ...
            End If
            If (BirthDate.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(5).Value = CType(BirthDate.Value,Date)
            Else
            ...
            Else
                Me.Adapter.UpdateCommand.Parameters(7).Value = CType(JobDescription,String)
            End If
            ...
            If (Original_BirthDate.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(20).Value = CType(Original_BirthDate.Value,Date)
            Else
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(24).Value = CType(Original_JobDescription,String)
            End If
