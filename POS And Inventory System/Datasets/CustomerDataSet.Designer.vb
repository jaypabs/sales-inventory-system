...
Partial Public Class CustomerDataSet
    ...
    Partial Public Class CustomerDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddCustomerRow(ByVal FirstName As String, ByVal LastName As String, ByVal Address As String, ByVal ContactNo As String, ByVal Email As String, ByVal Status As String) As CustomerRow
            Dim rowCustomerRow As CustomerRow = CType(Me.NewRow,CustomerRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, FirstName, LastName, Address, ContactNo, Email, Status}
    ...
    Partial Public Class CustomerRow
        ...
        Public Function IsContactNoNull() As Boolean
            Return Me.IsNull(Me.tableCustomer.ContactNoColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Sub SetContactNoNull()
            Me(Me.tableCustomer.ContactNoColumn) = Global.System.Convert.DBNull
        End Sub
    ...
    Partial Public Class CustomerTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Customer` WHERE ((`CustomerID` = ?) AND ((? = 1 AND `FirstName` IS N"& _ 
                ...
                "?)) AND ((? = 1 AND `Address` IS NULL) OR (`Address` = ?)) AND ((? = 1 AND `Cont"& _ 
                "actNo` IS NULL) OR (`ContactNo` = ?)) AND ((? = 1 AND `Email` IS NULL) OR (`Emai"& _ 
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `Customer` (`FirstName`, `LastName`, `Address`, `ContactNo`, `Email`,"& _ 
                " `Status`) VALUES (?, ?, ?, ?, ?, ?)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Customer` SET `FirstName` = ?, `LastName` = ?, `Address` = ?, `ContactNo`"& _ 
                " = ?, `Email` = ?, `Status` = ? WHERE ((`CustomerID` = ?) AND ((? = 1 AND `First"& _ 
                "Name` IS NULL) OR (`FirstName` = ?)) AND ((? = 1 AND `LastName` IS NULL) OR (`La"& _ 
                "stName` = ?)) AND ((? = 1 AND `Address` IS NULL) OR (`Address` = ?)) AND ((? = 1"& _ 
                " AND `ContactNo` IS NULL) OR (`ContactNo` = ?)) AND ((? = 1 AND `Email` IS NULL)"& _ 
                " OR (`Email` = ?)) AND ((? = 1 AND `Status` IS NULL) OR (`Status` = ?)))"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT CustomerID, FirstName, LastName, Address, ContactNo, Email, Status FROM Cu"& _ 
                "stomer"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1) = New Global.System.Data.OleDb.OleDbCommand()
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT CustomerID, FirstName, LastName, Address, ContactNo, Email, Status FROM Cu"& _ 
                "stomer WHERE (CustomerID = ?)"
        ...
        Public Overloads Overridable Function FillBy(ByVal dataTable As CustomerDataSet.CustomerDataTable, ByVal CustomerID As Integer) As Integer
        ...
        Public Overloads Overridable Function GetDataBy(ByVal CustomerID As Integer) As CustomerDataSet.CustomerDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(1)
            Me.Adapter.SelectCommand.Parameters(0).Value = CType(CustomerID,Integer)
            Dim dataTable As CustomerDataSet.CustomerDataTable = New CustomerDataSet.CustomerDataTable()
            Me.Adapter.Fill(dataTable)
        ...
        Public Overloads Overridable Function Delete(ByVal Original_CustomerID As Integer, ByVal Original_FirstName As String, ByVal Original_LastName As String, ByVal Original_Address As String, ByVal Original_ContactNo As String, ByVal Original_Email As String, ByVal Original_Status As String) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal FirstName As String, ByVal LastName As String, ByVal Address As String, ByVal ContactNo As String, ByVal Email As String, ByVal Status As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal FirstName As String, ByVal LastName As String, ByVal Address As String, ByVal ContactNo As String, ByVal Email As String, ByVal Status As String, ByVal Original_CustomerID As Integer, ByVal Original_FirstName As String, ByVal Original_LastName As String, ByVal Original_Address As String, ByVal Original_ContactNo As String, ByVal Original_Email As String, ByVal Original_Status As String) As Integer
            If (FirstName Is Nothing) Then
