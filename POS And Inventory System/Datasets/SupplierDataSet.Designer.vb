...
Partial Public Class SupplierDataSet
    ...
    Partial Public Class SupplierDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddSupplierRow(ByVal Name As String, ByVal Address As String, ByVal ContactPerson As String, ByVal ContactNo As String, ByVal Fax As String, ByVal Email As String) As SupplierRow
            Dim rowSupplierRow As SupplierRow = CType(Me.NewRow,SupplierRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, Name, Address, ContactPerson, ContactNo, Fax, Email}
...
Namespace SupplierDataSetTableAdapters
    ...
    Partial Public Class SupplierTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Supplier` WHERE ((`SupplierID` = ?) AND ((? = 1 AND `Name` IS NULL) "& _ 
                "OR (`Name` = ?)) AND ((? = 1 AND `Address` IS NULL) OR (`Address` = ?)) AND ((? "& _ 
                "= 1 AND `ContactPerson` IS NULL) OR (`ContactPerson` = ?)) AND ((? = 1 AND `Cont"& _ 
                "actNo` IS NULL) OR (`ContactNo` = ?)) AND ((? = 1 AND `Fax` IS NULL) OR (`Fax` ="& _ 
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `Supplier` (`Name`, `Address`, `ContactPerson`, `ContactNo`, `Fax`, `"& _ 
                "Email`) VALUES (?, ?, ?, ?, ?, ?)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Supplier` SET `Name` = ?, `Address` = ?, `ContactPerson` = ?, `ContactNo`"& _ 
                " = ?, `Fax` = ?, `Email` = ? WHERE ((`SupplierID` = ?) AND ((? = 1 AND `Name` IS"& _ 
                " NULL) OR (`Name` = ?)) AND ((? = 1 AND `Address` IS NULL) OR (`Address` = ?)) A"& _ 
                "ND ((? = 1 AND `ContactPerson` IS NULL) OR (`ContactPerson` = ?)) AND ((? = 1 AN"& _ 
                "D `ContactNo` IS NULL) OR (`ContactNo` = ?)) AND ((? = 1 AND `Fax` IS NULL) OR ("& _ 
                "`Fax` = ?)) AND ((? = 1 AND `Email` IS NULL) OR (`Email` = ?)))"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT SupplierID, Name, Address, ContactPerson, ContactNo, Fax, Email FROM Suppl"& _ 
                "ier"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1) = New Global.System.Data.OleDb.OleDbCommand()
            Me._commandCollection(1).Connection = Me.Connection
            Me._commandCollection(1).CommandText = "SELECT SupplierID, Name, Address, ContactPerson, ContactNo, Fax, Email FROM Suppl"& _ 
                "ier"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE SupplierID = ?"
            Me._commandCollection(1).CommandType = Global.System.Data.CommandType.Text
            Me._commandCollection(1).Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("SupplierID", Global.System.Data.OleDb.OleDbType.[Integer], 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "SupplierID", Global.System.Data.DataRowVersion.Current, false, Nothing))
        End Sub
        ...
        Public Overloads Overridable Function FillBy(ByVal dataTable As SupplierDataSet.SupplierDataTable, ByVal SupplierID As Integer) As Integer
        ...
        Public Overloads Overridable Function GetDataBy(ByVal SupplierID As Integer) As SupplierDataSet.SupplierDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(1)
            Me.Adapter.SelectCommand.Parameters(0).Value = CType(SupplierID,Integer)
            Dim dataTable As SupplierDataSet.SupplierDataTable = New SupplierDataSet.SupplierDataTable()
            Me.Adapter.Fill(dataTable)
        ...
        Public Overloads Overridable Function Delete(ByVal Original_SupplierID As Integer, ByVal Original_Name As String, ByVal Original_Address As String, ByVal Original_ContactPerson As String, ByVal Original_ContactNo As String, ByVal Original_Fax As String, ByVal Original_Email As String) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal Name As String, ByVal Address As String, ByVal ContactPerson As String, ByVal ContactNo As String, ByVal Fax As String, ByVal Email As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal Name As String, ByVal Address As String, ByVal ContactPerson As String, ByVal ContactNo As String, ByVal Fax As String, ByVal Email As String, ByVal Original_SupplierID As Integer, ByVal Original_Name As String, ByVal Original_Address As String, ByVal Original_ContactPerson As String, ByVal Original_ContactNo As String, ByVal Original_Fax As String, ByVal Original_Email As String) As Integer
            If (Name Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(12).Value = CType(Original_ContactPerson,String)
            End If
            If (Original_ContactNo Is Nothing) Then
