...
Public Class frmInvoiceHistory
    ...
    Private Sub frmInvoiceHistory_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        sSql = "SELECT InvoiceID, InvoiceNo, DateDelivered, [LastName] & ', ' & [FirstName] AS Name, Net, DeliveryStatus " _
    ...
    Private Sub btnSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        ...
        Else
            sSql = "SELECT InvoiceID, InvoiceNo, DateDelivered, [LastName] & ', ' & [FirstName] AS Name, Net, DeliveryStatus " _
                    & "FROM Invoice INNER JOIN Customer ON Invoice.CustomerID = Customer.CustomerID WHERE [Name] Like '%" & txtSearch.Text & "%'"
        End If
    ...
    Private Sub dgvList_CellDoubleClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvList.CellDoubleClick
        ...
        InvoiceID = dgvList.Item(0, i).Value
