...
Public Class frmProductReceiveHistory
    ...
    Dim sSql As String
    Dim ProductReceiveID As Integer

    Private Sub frmProductReceiveHistory_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        sSql = "SELECT ProductReceiveID, InvoiceNo, DateReceived, Name, Net, ReceiveStatus " _
                & "FROM ProductReceive INNER JOIN Supplier ON ProductReceive.SupplierID = Supplier.SupplierID"
    ...
    Private Sub btnSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        ...
        Else
            sSql = "SELECT ProductReceiveID, InvoiceNo, DateReceived, Name, Net, ReceiveStatus " _
                & "FROM ProductReceive INNER JOIN Supplier ON ProductReceive.SupplierID = Supplier.SupplierID WHERE [Name] Like '%" & txtSearch.Text & "%'"
        End If
    ...
    Private Sub dgvList_CellDoubleClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvList.CellDoubleClick
        ...
        ProductReceiveID = dgvList.Item(0, i).Value
