...
Public Class frmEmployeeList
    ...
    Private Sub frmEmployeesList_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        Try
            sSql = "SELECT EmployeeID, FirstName, LastName, ContactNo, Email, Address, [Position] FROM Employee"
    ...
    Private Sub LoadDS(ByVal sSQL As String)
        ...
        dtSource = ds.Tables("Employee")
    End Sub

    Private Sub btnNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNew.Click
        Dim Employee As New frmEmployee

        Employee.getFormState = modGlobal.FormState.adStateAddMode
    ...
    Private Sub btnSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        If txtSearch.Text = "" Then
            sSql = "SELECT EmployeeID, FirstName, LastName, ContactNo, Email, Address, [Position] FROM Employee"
        Else
            sSql = "SELECT EmployeeID, FirstName, LastName, ContactNo, Email, Address, [Position] FROM Employee WHERE [FirstName] Like '%" & txtSearch.Text & "%' OR [LastName] Like '%" & txtSearch.Text & "%'"
        End If
    ...
    Private Sub dgvList_CellDoubleClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvList.CellDoubleClick
        ...
        EmployeeID = dgvList.Item(0, i).Value
