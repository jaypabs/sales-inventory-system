...
Public Class frmCustomerList
    ...
    Private Sub frmCustomersList_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        Try
            sSql = "SELECT CustomerID, FirstName, LastName, Address, ContactNo FROM Customer"
    ...
    Private Sub btnNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNew.Click
        Dim Customer As New frmCustomer

        Customer.getFormState = modGlobal.FormState.adStateAddMode
    ...
    Private Sub btnSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        If txtSearch.Text = "" Then
            sSql = "SELECT CustomerID, FirstName, LastName, Address, ContactNo FROM Customer"
        Else
            sSql = "SELECT CustomerID, FirstName, LastName, Address, ContactNo FROM Customer WHERE [FirstName] Like '%" & txtSearch.Text & "%' OR [LastName] Like '%" & txtSearch.Text & "%'"
        End If
    ...
    Private Sub dgvList_CellDoubleClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvList.CellDoubleClick
        ...
        CustomerID = dgvList.Item(0, i).Value
