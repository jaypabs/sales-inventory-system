...
Public Class frmSupplierList
    ...
    Private Sub frmSuppliersList_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        Try
            sSql = "SELECT SupplierID, [Name], Address, ContactPerson, ContactNo, Email FROM Supplier"
    ...
    Private Sub LoadDS(ByVal sSQL As String)
        ...
        dtSource = ds.Tables("Supplier")
    End Sub

    Private Sub btnNew_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnNew.Click
        Dim Supplier As New frmSupplier

        Supplier.getFormState = modGlobal.FormState.adStateAddMode
    ...
    Private Sub btnSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        If txtSearch.Text = "" Then
            sSql = "SELECT SupplierID, [Name], Address, ContactPerson, ContactNo, Email FROM Supplier"
        Else
            sSql = "SELECT SupplierID, [Name], Address, ContactPerson, ContactNo, Email FROM Supplier WHERE [Name] Like '%" & txtSearch.Text & "%' OR [ContactPerson] Like '%" & txtSearch.Text & "%'"
        End If
    ...
    Private Sub dgvList_CellDoubleClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvList.CellDoubleClick
        ...
        SupplierID = dgvList.Item(0, i).Value
