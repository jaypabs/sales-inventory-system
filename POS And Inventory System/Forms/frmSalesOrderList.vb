...
Public Class frmSalesOrderList
    ...
    Private Sub frmSalesOrderList_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        Try
            sSql = "SELECT SalesOrderID, [LastName] & ', ' & [FirstName] AS Name, Address, SODate, Total, DiscountAmount, Net " _
                    & "FROM SalesOrder INNER JOIN Customer ON SalesOrder.CustomerID = Customer.CustomerID"
    ...
    Private Sub btnSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        ...
        Else
            sSql = "SELECT SalesOrderID, [LastName] & ', ' & [FirstName] AS Name, Address, SODate, Total, DiscountAmount, Net " _
                    & "FROM SalesOrder INNER JOIN Customer ON SalesOrder.CustomerID = Customer.CustomerID WHERE [Name] Like '%" & txtSearch.Text & "%' OR [Address] Like '%" & txtSearch.Text & "%'"
        End If
    ...
    Private Sub dgvList_CellDoubleClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvList.CellDoubleClick
        ...
        SalesOrderID = dgvList.Item(0, i).Value
